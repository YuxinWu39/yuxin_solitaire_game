...
const EditLink = ({ show }, curUser) => {
  return show ? (
    <EditLinkBase>
      <Link to={`/profile/${curUser}/edit`}>Edit Profile</Link>
    </EditLinkBase>
  ) : null;
};
...
//         <Link to={{pathname: `/profile/${username}/edit`, curState: state}} style={{marginLeft: "205px"}}>Edit Profile</Link>
//         : undefined;
// }
